...
PM_START_TEXT = """
Hello There User[!](https://telegra.ph/file/b9fb2a3ca13070506505e.jpg), My Name Is Pinchu Kun I am A Highly Advanced Telegram Bot with Lots of Amazing Modules & Tools.
Press /help To See My Commands.
"""
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *PinchuKun*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_Pinchu's licensed under the GNU General Public License v3.0_
                 \nHere is the [📇Updates](https://t.me/BotProtocol)
                 \n\nIf you have any question about Pinchu, let us know at @BotProtocolSupport.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
